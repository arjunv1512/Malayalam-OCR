...
public class RTtemp1 {
	...
	public static void TrainerTest() {
		...
		files[0] = new File ("data/Training Images/16_00.bmp");
		files[1] = new File ("data/Training Images/17_00.bmp");
		files[2] = new File ("data/Training Images/18_00.bmp");
		files[3] = new File ("data/Training Images/19_00.bmp");
		files[4] = new File ("data/Training Images/20_00.bmp");
		...
		files = new File[15];
		files[0] = new File ("data/Training Images/16_01.bmp");
		files[1] = new File ("data/Training Images/17_01.bmp");
		files[2] = new File ("data/Training Images/18_01.bmp");
		files[3] = new File ("data/Training Images/19_01.bmp");
		files[4] = new File ("data/Training Images/20_01.bmp");
	
		files[5] = new File ("data/Training Images/16_02.bmp");
		files[6] = new File ("data/Training Images/17_02.bmp");
		files[7] = new File ("data/Training Images/18_02.bmp");
		files[8] = new File ("data/Training Images/19_02.bmp");
		files[9] = new File ("data/Training Images/20_02.bmp");
		
		files[10] = new File ("data/Training Images/16_03.bmp");
		files[11] = new File ("data/Training Images/17_03.bmp");
		files[12] = new File ("data/Training Images/18_03.bmp");
		files[13] = new File ("data/Training Images/19_03.bmp");
		files[14] = new File ("data/Training Images/20_03.bmp");
		...
		Neocognitron n = trainer.getNeocognitron(2);
