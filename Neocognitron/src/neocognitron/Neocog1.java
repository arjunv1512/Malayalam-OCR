 ...
 *
 */
public class Neocog1 implements Serializable {
	 ...
	 */
	public Neocog1(NeocognitronStructure initStruct) {
		...
		for (int l = 0; l < s.numLayers; l++) {
			...
			//s.numSPlanes[l], s.sLayerSizes[l],
	...
	public int propagate(double[][] input, boolean train) {
		...
		//System.out.println(output.getPointsOnPlanes(0, 0));
		return (determineOutput(output.getPointsOnPlanes(0, 0))+100);
	}
	 ...
	 */
	public static void SaveNeocognitron(Neocog1 n, File f) {
	 ...
	 */
	public static Neocog1 OpenNeocognitron(File f) {
